...
for random_seed in random_seeds_list:
    ...
    NRMSE_test = analysis.normalized_root_mean_squared_error(OUTPUT_test[:,2], OUTPUT_predicted_test[:,2], norm='std')
    NRMSE_Seta_3_without.append(NRMSE_test)
    ...
    R2_test = analysis.coefficient_of_determination(OUTPUT_test[:,2], OUTPUT_predicted_test[:,2])
    R2_Seta_3_without.append(R2_test)
...
np.savetxt('' + data_tag + '-NRMSE-Seta-3-without-Seta-' + str(n_components) + 'D-LDM.csv', np.array(NRMSE_Seta_3_without), delimiter=',', fmt='%.16e')
...
np.savetxt('' + data_tag + '-R2-Seta-3-without-Seta-' + str(n_components) + 'D-LDM.csv', np.array(R2_Seta_3_without), delimiter=',', fmt='%.16e')
...
for random_seed in random_seeds_list:
    ...
    NRMSE_test = analysis.normalized_root_mean_squared_error(OUTPUT_test[:,2], OUTPUT_predicted_test[:,2], norm='std')
    NRMSE_Seta_3_with.append(NRMSE_test)
...
np.savetxt('' + data_tag + '-NRMSE-Seta-3-with-Seta-' + str(n_components) + 'D-LDM.csv', np.array(NRMSE_Seta_3_with), delimiter=',', fmt='%.16e')
...
np.savetxt('' + data_tag + '-R2-Seta-3-with-Seta-' + str(n_components) + 'D-LDM.csv', np.array(R2_Seta_3_with), delimiter=',', fmt='%.16e')